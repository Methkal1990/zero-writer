  ...
  return (
    <div className="h-full flex flex-col min-h-0">
      <div className="flex-1 min-h-0 overflow-auto divide-y">
        ...
        {loading && (
          <div className="p-3 text-sm text-neutral-500">Thinking…</div>
        )}
      </div>
      <div className="flex-shrink-0 p-2 border-t flex gap-2">
        <input
          value={input}
        ...
        <button
          onClick={send}
          className="px-3 rounded-lg bg-[#1C2B3A] text-white"
        >
          Send
        </button>
      </div>
      ...
      <div className="flex-shrink-0 p-2 border-t space-y-2">
        ...
        <textarea
          ...
          placeholder="Paste bullet points or notes…"
        />
        <button
          disabled={genLoading}
          onClick={generateChapter}
          className="px-3 py-1 rounded bg-[#F5B942] text-[#1C2B3A]"
        >
